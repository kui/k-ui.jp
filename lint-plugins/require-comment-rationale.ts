          ...
          Program() {
            for (const comment of context.sourceCode.getAllComments()) {
              ...
              context.report({
                range: comment.range,
                message:
                  "Delete this comment, prefix it with a rationale marker (WHY:, SAFETY:, INVARIANT:, HACK:) followed by the reason, or rewrite it as a JSDoc block (/** ... */) attached to the following declaration.",
              });
            }
          },
        };
